...
namespace TagHelperFun.CustomAttributes
{
	...
	{
		public OptionsDataBindAttribute(string options, string value, bool usarSomenteValue) : base("")
		{
		...
		public OptionsDataBindAttribute(string options, string value) : base("")
		{
			_options = options;
			_value = value;
			TagValue = MontarTagValue();
		...
		public OptionsDataBindAttribute(string options, string value, string evento) : base("")
		{
			_options = options;
			_value = value;
			_evento = evento;
		...
		public override string OriginalValue => _value;
