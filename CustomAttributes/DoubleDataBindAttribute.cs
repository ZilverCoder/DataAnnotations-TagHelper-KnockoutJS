...
namespace TagHelperFun.CustomAttributes
{
    ...
    {
        public DoubleDataBindAttribute(string value, int decimais, long maxLeftDigits = -1) : base("")
        {
            _decimais = decimais;
            MontarDataBind(value, maxLeftDigits);
        }
        
        public DoubleDataBindAttribute(string value, string decimais, long maxLeftDigits = -1) : base("")
        {
            _decimaisObservable = decimais;
            MontarDataBind(value, maxLeftDigits);
        }

		public DoubleDataBindAttribute(string value, long maxLeftDigits = -1) : base("") => MontarDataBind(value, maxLeftDigits);
