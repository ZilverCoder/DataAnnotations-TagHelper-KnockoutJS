...
namespace TagHelperFun.CustomAttributes
{
	...
	public class ValueDataBindAttribute : DataBindAttribute
	{
		...
		public ValueDataBindAttribute(string value) : this(value, ValueUpdates.NotSet) { }

		public ValueDataBindAttribute(string value, ValueUpdates valueUpdate) : base("")
		{
